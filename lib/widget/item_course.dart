...
class _ItemCourseState extends State<ItemCourse> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.isCourse
                          ? "${widget.model.lessons} Choregraphy"
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: colorUpdater(widget.model.subscriptionStatus),
                        borderRadius: BorderRadius.all(Radius.circular(5.0)),
                      ),
                      child: Center(
                          child: Text(
                        textUpdater(widget.model.subscriptionStatus,
                            widget.userType),
                        style: styleProvider(
  ...
  LinearGradient colorUpdater(String? status) {
  ...
  String textUpdater(String? status, UserType userType) {

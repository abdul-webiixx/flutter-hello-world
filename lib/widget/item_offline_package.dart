...
class ItemClassPackageSubscriptions extends StatelessWidget {
  final OfflineClassPackageDetails model;
  ItemClassPackageSubscriptions({Key? key, required this.model}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              "${model.duration} ${model.durationType}",

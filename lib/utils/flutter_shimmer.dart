...
Decoration customBoxDecoration({
  ...
  return BoxDecoration(
      borderRadius:
          isRectBox ? BorderRadius.circular(10) : BorderRadius.circular(100),
...
class BoxShimmer extends StatefulWidget {
  ...
  const BoxShimmer(
      ...
      : super(key: key);
  @override
  _BoxShimmerState createState() => _BoxShimmerState();
}
...
class ListVerticalShimmer extends StatefulWidget {
  final bool isDarkMode;
  final bool isPurplishMode;
  final AlignmentGeometry beginAlign;
  final AlignmentGeometry endAlign;
  ...
  const ListVerticalShimmer(
      ...
      : super(key: key);
  @override
  _ListVerticalShimmerState createState() => _ListVerticalShimmerState();
}

class _ListVerticalShimmerState extends State<ListVerticalShimmer>
    with SingleTickerProviderStateMixin {
  late AnimationController _animationController;
  late Animation<double> _animation;
...
class ListBoxVerticalShimmer extends StatefulWidget {
  final bool isDarkMode;
  final bool isPurplishMode;
  final AlignmentGeometry beginAlign;
  final AlignmentGeometry endAlign;
  ...
  const ListBoxVerticalShimmer(
      ...
      : super(key: key);
  @override
  _ListBoxVerticalShimmerState createState() => _ListBoxVerticalShimmerState();
}

class _ListBoxVerticalShimmerState extends State<ListBoxVerticalShimmer>
    with SingleTickerProviderStateMixin {
  late AnimationController _animationController;
  late Animation<double> _animation;
